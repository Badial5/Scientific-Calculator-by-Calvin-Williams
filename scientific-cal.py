...
root.title("KUC Scientific Calculator")
...
def abt():
    abt = "This calculator was developed using Tkinter, by the Computing Student of Kings University College Computing Society."
...
btn0 = Calculator("sin",1,0,sciCal,"blue")

btn1 = Calculator("cos",1,1,sciCal,"#DBA800")

btn2 = Calculator("tan",1,2,sciCal,"blue")

btn3 = Calculator("log",1,3,sciCal, "#DBA800")

btn4 = Calculator("ln",1,4,sciCal, "blue")
...
btn12 = Calculator("deg",3,2,sciCal, "#DBA800")

btn13 = Calculator("rad",3,3,sciCal)

btn14 = Calculator("e",3,4,sciCal,"blue")

btn15 = Calculator("/",4,0,click,"blue")

btn16 = Calculator("*",4,1,click,"#DBA800")

btn17 = Calculator("-",4,2,click,"blue")
...
btn30 = Calculator("C",7,0,clr,"blue")

btn31 = Calculator("⌦",7,1,backspace,"#DBA800")

btn32 = Calculator("00",7,2,click)

btn33 = Calculator(".",7,3,click)

btn34 = Calculator("=",7,4,calculate, "#DBA800")
